...
namespace SkinnedModel
{
    ...
    public class SkinningData
    {
        ...
        public SkinningData(
            ...
            List<int> pskeletonHierarchy,
            List<int[]> cskeletonHierarchy,
            Dictionary<string, int> boneMap)
        {
            AnimationClips = animationClips;
            BindPose = bindPose;
            InverseBindPose = inverseBindPose;
            ParentSkeletonHierarchy = pskeletonHierarchy;
            ChildrenSkeletonHierarchy = cskeletonHierarchy;
            BoneMap = boneMap;
        }
        ...
        /// <summary>
        /// Gets a collection of bone indexs. These are stored by name in a
        /// dictionary, so there could for instance be bones for "Neck", "Head",
        /// "LeftFrontLeg", etc.
        /// </summary>
        [ContentSerializer]
        ...
        /// </summary>
        [ContentSerializer]
        public List<int> ParentSkeletonHierarchy { get; private set; }

        /// <summary>
        /// For each bone in the skeleton, stores the index of the children bones.
        /// </summary>
        [ContentSerializer]
        public List<int[]> ChildrenSkeletonHierarchy { get; private set; }
    }
}
